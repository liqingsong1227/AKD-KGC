...
from trainer_nbf_ind import Trainer
...
if __name__ == '__main__':
	...
	trainer = Trainer(train_data, test_data, data_loader_list, ultra, optimizer, scheduler, device=device, hyperparams=hyperparams)
	if arg.finetune:
		trainer.run()
